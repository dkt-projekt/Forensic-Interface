<?php
  $siteTitle = 'New Document Generation - Information Forensics';
...
?>
  ...
  <div class="row">
    <div class="col-lg-10 col-md-10 col-sm-10 col-lg-offset-1 col-md-offset-1 col-sm-offset-1">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="page-header">Generate a New Document</h2>
        </div>
      </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="row">
                <div class="form-group">
                  <label>Name</label>
                  <input class="form-control" placeholder="Enter a name for the document" name="documentName" id="documentName" value="Document_Name" ng-model="documentNameText" ng-init="documentNameText = 'Document_Name'">
                </div>
              </div>
            </div>
...
?>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12" style="border-style:solid;border-width:1px 0px 0px 0px;border-color:white;padding-top:10px">
              <div class="row">
                ...
                <a href="collectionDetail.php?view=documents" class="btn btn-danger">Cancel</a>
              </div>
            </div>
          </div>
        </div>
...
$("#upload").submit(function(event) {
	...
	var posting = $.post( url, { documentName: $('#documentName').val(), files: $('#fileNames').html() } );
